<div class="px-10 py-10">
    ...
    <div name="listaParticipantes" class="border-2 border-gray-300 bg-gray-300 rounded-md">
        <br><hr class="border-t-3 border-gray-700 border-solid">

        @foreach ($participantes as $participante)
            <div name="{{ 'participante'.$participante->id }}" class="pt-7 pl-2 rounded-md">
            ...
            <br><hr class="border-t-3 border-gray-700 border-solid"><br>
        @endforeach
    </div>
